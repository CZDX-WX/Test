...
public class MusicPlayShowActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList= MyMusicActivity.getSongList();
    ...
    private void initMediaPlayer(){
        Glide.with(MusicPlayShowActivity.this).load(songList.get(pos).getImage()).into(imageView);
